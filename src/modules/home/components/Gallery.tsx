    ...
    <div className="flex bg-[#eee] justify-center py-16 px-5">
      <div className="flex flex-col w-full max-w-[1200px] justify-center items-center">
        ...
        <Swiper
          ...
          className="mySwiper !py-[40px] [&>.swiper-wrapper>.swiper-slide]:bg-[#fff0] 
            ...
            [&>.swiper-wrapper>.swiper-slide-active]:before:border-red [&>.swiper-wrapper>.swiper-slide-active]:before:rounded-3xl
            [&>.swiper-pagination>.swiper-pagination-bullet]:!bg-[#d1d1d7]
            [&>.swiper-pagination>.swiper-pagination-bullet-active]:!bg-red"
        >
          {data.map((item, idx) => (
            <SwiperSlide key={idx}>
