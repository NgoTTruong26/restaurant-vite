...
export default function Column2() {
  ...
  return (
    <div className="flex-1 flex justify-center items-center py-4 w-[60%] px-3">
      <div className="flex flex-col">
        ...
        <div className="flex justify-center mt-3">
          <button className="btn text-[#fff] font-medium bg-[#fd2424] rounded-xl py-2 px-4 hover:!bg-[#e51717] w-full">
