      ...
      <div className="flex flex-col max-w-[1200px] items-center w-full">
        <div className="flex flex-col items-center pb-10 max-sm:w-[90%]">
          ...
          <div className="capitalize text-[48px] font-amatic">
            {"Learn More "}
            <span className="text-[#ce1212] text-[48px]">About Us</span>
          </div>
        </div>
        <div className="flex justify-between max-md:flex-col max-md:items-center">
          <div className="relative w-[58%] bg-[url('https://bootstrapmade.com/demo/templates/Yummy/assets/img/about.jpg')] bg-no-repeat bg-cover min-h-[400px] max-sm:w-[90%] max-sm:min-h-[300px] max-md:w-[80%]">
            <div className="flex flex-col absolute bottom-[10%] right-[10%] left-[10%] items-center bg-[#fff] p-6">
              ...
              <div className="text-[#ce1212] text-[28px] font-bold pb-2 max-sm:text-[16px]">
                +1 5589 55488 55
              </div>
            </div>
          </div>
          <div className="w-[38%] flex flex-col max-sm:w-[90%] max-md:w-[80%] max-md:pt-14">
